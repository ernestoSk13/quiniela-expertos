...
export default function BonusSummary({ bonus, teams, teamsMap, onSave }: Props) {
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {canEdit && !editing && (
          <button
            ...
            className="text-xs text-[var(--accent-light)] hover:text-[var(--accent-light)] transition-colors"
          >
            Editar
          </button>
        )}
